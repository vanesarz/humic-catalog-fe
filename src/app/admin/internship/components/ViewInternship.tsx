...
export default function ViewInternship({ open, onClose, data }: ViewInternshipProps) {
  if (!data) return null;

  return (
    <Dialog open={open} onClose={onClose} maxWidth="max-w-xl">
      <h2 className="text-xl font-semibold">Internship Detail</h2>
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-500 text-justify">Internship Project</p>
